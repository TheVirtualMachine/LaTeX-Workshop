...
\lstset {%
	...
	columns=flexible,
	morekeywords={\therefore, \because, \pgfplotsset, \includepdf, \includegraphics},
}
...
\begin{document}
	...
	\begin{frame}[fragile]
		...
		\begin{example}
			\begin{lstlisting}[numbers=none, gobble=16]
				\includepdf[pages={1,3}]{WorkshopCopy.pdf} % Include pages 1 and 3 of this workshop.
			\end{lstlisting}
		\end{example}
		The next two slides will now have the first and third slide of this presentation repeated.
	\end{frame}
	\includepdf[pages={1,3}]{WorkshopCopy} % Include pages 1 and 3 of this workshop.
\end{document}
